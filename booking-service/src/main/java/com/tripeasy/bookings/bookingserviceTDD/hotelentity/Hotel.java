package com.tripeasy.bookings.bookingserviceTDD.hotelentity;
...
public class Hotel {
	...
	public Hotel(Integer hotelId, String hotelName, HotelAddress address, HashMap<Integer, String> review,
			Set<Room> rooms, List<String> photos, Integer totalRooms, Integer totalAvailableRooms,
			Map<String, List<String>> facilities, String description, String lattitude, String longitude) {
		super();
